# DESIGN.md Spec (Vendored Reference)

Source: google-labs-code/design.md `docs/spec.md`
Source URL: https://github.com/google-labs-code/design.md/blob/main/docs/spec.md
Pinned source commit: `887a4bff8943f37ef7c9a2d8c01266f18e3fe895`
License: Apache License 2.0 (see repository copy at `licenses/APACHE-2.0.txt`)
Vendoring note: copied verbatim from upstream after this attribution header for local skill reference.
